...
//   2) Display all the countrys flags in consoleusing rest country API URL ?


xhr=new XMLHttpRequest();
xhr.open("GET","https://restcountries.eu/data/afg.svg");
xhe.send();
xhr.onload=function(){
...
let asiaregion = countries.forEach(countries => {
    console.log("countries",countries.name,"region",countries.region,"subregion",countries.subregion,"population",countries.population)
})
